...
public class ValidationExceptionMessages {
    ...
    public static final String UNIQUE_NAME_VALIDATION_MSG = "Task name should be unique.";
    ...
    public static final String DESCRIPTION_VALIDATION_MSG = "Description is to short.";
    public static final String DISCOUNT_VALIDATION_MSG = "Discount can not be more than 100%";
}
